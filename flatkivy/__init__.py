...
"""Path to Flat Kivy package directory."""

fonts_path = os.path.join(path, f"fonts/lato{os.sep}")
"""Path to fonts directory."""

icons_path = os.path.join(path, f"icons/iconmoon{os.sep}")
"""Path to icons directory."""

images_path = os.path.join(path, f"images{os.sep}")
"""Path to images directory."""

Logger.info(f"FlatKivy: v{__version__}")
